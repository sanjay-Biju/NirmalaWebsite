    ...
    <div className='about-nirmala-sub'>
        ...
        <div className='about-nirmala-sub-2'>
            ...
            <div className='sub2of2'>
                <p style={{marginTop:'10px', marginLeft:'10px'}}>Nirmala College, Muvattupuzha is a first-grade college which is established in 1953 and has completed 70 years of glorious service to the cause of higher education. The college is managed by the catholic diocese of Kothamangalam and treads on to conquer new heights in the path of academic excellence.The college is re-accredited by NAAC with A++ grade with CGPA 3.73 in 2021. Towering aloft on the peak of a high hill, surrounded by luxuriant vegetation, intermingled by shady trees and distant from the clamour and confusion of the city, stands Nirmala College; the beacon light of learning and scholarship. Renowned for its picturesque landscape and tranquil serenity, the college provides a congenial atmosphere for study and research.</p>
                <p style={{marginTop:'10px', marginLeft:'10px'}}>The college is situated in Avoly Panchayat of Muvattupuzha taluk in the district of Ernakulam. It was founded in 1953 by His Grace Most Rev. Dr Augustine Kandathil, Arch Bishop of Ernakulam to meet the educational needs of the eastern districts of north Travancore, especially of the Catholic community, at a time, when higher education was the wildest dream of the ordinary people living in the villages and the suburbs. In 1955, the college was raised to First Grade by starting B.A., B.Sc. and B.Com courses. Post graduate courses were introduced in 1965 and research facilities are now available in the departments. Thus over the years, the college has grown in size and stature. The divine legacy left behind by the founders of this college and the rich heritage built up by their successors have placed us on a high pedestal in the field of education and research.</p>
                <p style={{marginTop:'10px', marginLeft:'10px'}}>Now Nirmala is one of the foremost colleges in Kerala with over 3158 students and over 140 faculty members spread over 17 UG programmes, 14 PG programmes and 7 research programmes. The college is affiliated to Mahatma Gandhi University, Kottayam and is nationally accredited by NAAC at B grade (CGPA of 2.85) in March 2013. In 2017, the college was ranked the 91st position among all arts and science colleges in India by the Ministry of HRD, Govt. of India in the NIRF rankings. Also, the college is accorded the star college status in 2017 by the Dept. of Bio-Technology, Govt. of India, in recognition of the advancements made by the science departments of the college in scientific research.</p>
            </div>
        </div>
    </div>
</div>
...
export default HistoryOfNirmala