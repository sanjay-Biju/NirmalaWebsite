...
<Navbar className='main-nav-box'>
            ...
            <div className='AboutNirmala'>
                <div className='about-nirmala-sub'>
                    <div className='about-nirmala-sub-1'>Core Values</div>
                    <div className='about-nirmala-sub-2'>
                        ...
                        <div className='sub2of2-extra-core'>
                        <h5 style={{fontWeight:'bold', marginLeft:'50px',marginTop:'30px'}}>Trust in God</h5>
                        <h5 style={{fontWeight:'bold', marginLeft:'50px',marginTop:'30px'}}>Integrity of Chareacter</h5>
                        <h5 style={{fontWeight:'bold', marginLeft:'50px',marginTop:'30px'}}>Social Commitmment</h5>
                        <h5 style={{fontWeight:'bold', marginLeft:'50px',marginTop:'30px'}}>Pursuit Of Excellence</h5>
